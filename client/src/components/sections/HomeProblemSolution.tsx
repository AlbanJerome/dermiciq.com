      ...
      <div className="container-content">
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <Card className="p-8 border-border/80 shadow-sm">
            <h3 className="text-xl font-semibold text-foreground mb-4">{ps.problemTitle}</h3>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">{ps.problemClosing}</p>
          </Card>
