              ...
              {item.kind === "bullets" ? (
                <>
                  ...
                  {"footer" in item && item.footer ? (
                    <p className="text-sm text-muted-foreground mt-4 pt-4 border-t border-border/60">{item.footer}</p>
                  ) : null}
                </>
              ) : (
                <>
                  <p className="text-sm text-muted-foreground mb-3">{item.intro}</p>
                  ...
                  <p className="text-sm text-muted-foreground mt-auto">{item.closing}</p>
                </>
              )}
            </Card>
          ))}
